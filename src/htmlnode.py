...
class LeafNode(HTMLNode):
    def __init__(
        self, value, tag=None, props=None
    ):  # Setting contructor for optional tags, props, and no children
...
class ParentNode(HTMLNode):
    def __init__(
        self, tag, children, props=None
    ):  # Setting up contructor required tags/children, optional props, no value
        super().__init__(tag=tag, value=None, children=children, props=props)

    def to_html(self): # recrusively iterates through children then returns them as HTML
        children_html = ""
        if self.tag is None:
